...
function Settings.default()
		...
		ambient_volume = 0.8,
			...
			selected_sprint_practice_target = "floor:1",
			daily_records = {},
			time_attack_records = {},
			sprint_records = {},
			sprint_practice_records = {},
			runner_ghost_visible = true,
			runner_auto_save_pb_replay = true,
			runner_restart_confirmation = true,
			runner_practice_auto_restart = false,
			runner_show_medal_pace = true,
			runner_show_split_delta = true,
			runner_show_velocity = true,
			runner_show_technique_state = true,
			runner_input_display = false,
			runner_show_ghost_3d = true,
			total_runs = 0,
			total_victories = 0,
			total_burns = 0,
